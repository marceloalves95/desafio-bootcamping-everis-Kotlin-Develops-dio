...
/*
   ...
   | Agora Paula inventou um pequeno passatempo que envolve 3 caracteres: um dígito numérico,                       |
   ...
   | produto entre os dois dígitos.                                                                                 |
   |                                                                                                                |
   | Ela pediu para seu amigo Marcelo, que é bom em programação, para criar um programa para que encontre a         |
